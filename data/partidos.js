...
const MUNDIAL_DATA = {
  ...
  ranking: [
    ...
    { nombre:"Carlos",      apellido:"Delgado",      aciertos:2, total:72, campeon: " Ecuador| Países Bajos| España| Francia| Final " },
    ...
    { nombre:"Andrea",      apellido:"Soto",         aciertos:1, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    ...
    { nombre:"Mayra",       apellido:"Huerts",       aciertos:1, total:72, campeon: " Portugal | Francia | España | Portugal | Dieciseisavos " },
    { nombre:"Ronny",       apellido:"Moreira",      aciertos:1, total:72, campeon: " Francia | Argentina | Ecuador | Francia | Cuartos " },
    { nombre:"Aldo",        apellido:"Arevalo",      aciertos:1, total:72, campeon: " Portugal | Inglaterra | Argentina | Argentina | Semifinales " },
    { nombre:"Sandy",       apellido:"Carpio",       aciertos:2, total:72, campeon: " Francia | Argentina | Inglaterra | Francia | Fase de grupos " },
    { nombre:"Cristopher",  apellido:"Crespo",       aciertos:1, total:72, campeon: " Argentina | Brasil | Paraguay | Portugal | Octavos " },
    ...
    { nombre:"CARLOS",      apellido:"LOPEZ",        aciertos:2, total:72, campeon: " Francia | Portugal | Ecuador | España | Semifinales " },
    { nombre:"Lissette",    apellido:"Banchon",      aciertos:1, total:72, campeon: " España | Francia | Argentina | Argentina | Octavos " },
    { nombre:"Carlos",      apellido:"Ochoa",        aciertos:1, total:72, campeon: " Francia | Brasil | Ecuador | Francia | Semifinales " },
