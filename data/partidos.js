...
const MUNDIAL_DATA = {
  ...
  ranking: [
    ...
    { nombre:"David",       apellido:"Sellan",       aciertos:2, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    ...
    { nombre:"Paul",        apellido:"Garcia",       aciertos:2, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Paul",        apellido:"Rodríguez",    aciertos:1, total:72, campeon: " Portugal | España | Argentina | Brasil | Octavos " },
    ...
    { nombre:"Francisco",   apellido:"Camacho",      aciertos:2, total:72, campeon: " Portugal | Francia | Argentina | Francia | Octavos " },
    { nombre:"Gary",        apellido:"Laborde",      aciertos:2, total:72, campeon: " Francia | Portugal | Ecuador | Francia | Semifinales " },
    { nombre:"Julio",       apellido:"Mazacon",      aciertos:1, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    { nombre:"Kelvin",      apellido:"Cornejo",      aciertos:1, total:72, campeon: " España | Francia | Francia | España | Octavos " },
    { nombre:"Julio",       apellido:"Sanchez",      aciertos:2, total:72, campeon: " Portugal | Alemania | Brasil | Portugal | Octavos " },
    { nombre:"Oscar",       apellido:"Ortega",       aciertos:1, total:72, campeon: " Argentina | Francia | España | Francia | Octavos " },
    ...
    { nombre:"Andrea",      apellido:"Soto",         aciertos:2, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    ...
    { nombre:"Marcos",      apellido:"Ramírez",      aciertos:1, total:72, campeon: " Portugal | Francia | Ecuador | Portugal | Semifinales " },
    { nombre:"Mayra",       apellido:"Huerts",       aciertos:2, total:72, campeon: " Portugal | Francia | España | Portugal | Dieciseisavos " },
    { nombre:"Ronny",       apellido:"Moreira",      aciertos:1, total:72, campeon: " Francia | Argentina | Ecuador | Francia | Cuartos " },
    { nombre:"Aldo",        apellido:"Arevalo",      aciertos:2, total:72, campeon: " Portugal | Inglaterra | Argentina | Argentina | Semifinales " },
    { nombre:"Sandy",       apellido:"Carpio",       aciertos:2, total:72, campeon: " Francia | Argentina | Inglaterra | Francia | Fase de grupos " },
    ...
    { nombre:"Freddy",      apellido:"Pincay",       aciertos:1, total:72, campeon: " España | Argentina | Países Bajos | España | Octavos " },
    { nombre:"CARLOS",      apellido:"LOPEZ",        aciertos:3, total:72, campeon: " Francia | Portugal | Ecuador | España | Semifinales " },
    { nombre:"Lissette",    apellido:"Banchon",      aciertos:1, total:72, campeon: " España | Francia | Argentina | Argentina | Octavos " },
