...
const MUNDIAL_DATA = {
  ...
  config: {
    ...
    fechaLimiteFase: "2026-06-11T14:30:00",
  },
  ...
  fases: {
    ...
    grupos_j1: {
      ...
      partidos: [
        ...
        { id:"j_j1_2", local:"Austria",          visitante:"Jordania",             fecha:"15 de junio", hora:"23:00", grupo:"J" },
  ...
  ranking: [
    ...
    { nombre:"Carlos",    apellido:"Delgado",      aciertos:0, total:72, campeon: " Ecuador| Países Bajos| España| Francia| Final " },
    { nombre:"Paul",    apellido:"Garcia",      aciertos:0, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Paul",    apellido:"Rodríguez",      aciertos:0, total:72, campeon: " Portugal | España | Argentina | Brasil | Octavos " },
    { nombre:"Juan",    apellido:"Navarrete",      aciertos:0, total:72, campeon: " Francia| Portugal| Ecuador| Francia| Semifinales " },
    { nombre:"Dussan",    apellido:"Maruri",      aciertos:0, total:72, campeon: " Argentina | Francia | Brasil | Francia | Octavos " },
    { nombre:"Francisco",    apellido:"Camacho",      aciertos:0, total:72, campeon: " Portugal | Francia | Argentina | Francia | Octavos " },
    { nombre:"Gary",    apellido:"Laborde",      aciertos:0, total:72, campeon: " Francia | Portugal | Ecuador | Francia | Semifinales " },
    { nombre:"Julio",    apellido:"Mazacon",      aciertos:0, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    ...
    { nombre:"Jose",    apellido:"Bailon",      aciertos:0, total:72, campeon: " Francia | España | Países Bajos | Francia | Cuartos " },
    { nombre:"Joselyn",    apellido:"Salcedo",      aciertos:0, total:72, campeon: " Argentina | Portugal | Ecuador | Ecuador | Semifinales " },
    { nombre:"Jose",    apellido:"Crespo",      aciertos:0, total:72, campeon: " Francia | Argentina | España | Francia | Octavos " },
    { nombre:"Victor",    apellido:"Camacho",      aciertos:0, total:72, campeon: " Portugal | Francia | Brasil | Francia | Cuartos " },
    { nombre:"Marcos",    apellido:"Ramírez",      aciertos:0, total:72, campeon: " Portugal | Francia | Ecuador | Portugal | Semifinales " },
    { nombre:"Mayra",    apellido:"Huerts",      aciertos:0, total:72, campeon: " Portugal | Francia | España | Portugal | Dieciseisavos " },
    { nombre:"Ronny",    apellido:"Moreira",      aciertos:0, total:72, campeon: " Francia | Argentina | Ecuador | Francia | Cuartos " },
    { nombre:"Aldo",    apellido:"Arevalo",      aciertos:0, total:72, campeon: " Portugal | Inglaterra | Argentina | Argentina | Semifinales " },
    { nombre:"Sandy",    apellido:"Carpio",      aciertos:0, total:72, campeon: " Francia | Argentina | Inglaterra | Francia | Fase de grupos " },
    ...
    { nombre:"Steven",    apellido:"Ley",      aciertos:0, total:72, campeon: " Francia | Portugal | Brasil | Francia | Octavos " },
    { nombre:"Freddy",    apellido:"Pincay",      aciertos:0, total:72, campeon: " España | Argentina | Países Bajos | España | Octavos " },
    { nombre:"CARLOS",    apellido:"LOPEZ",      aciertos:0, total:72, campeon: " Francia | Portugal | Ecuador | España | Semifinales " },
