...
const MUNDIAL_DATA = {
  ...
  ranking: [
    ...
    { nombre:"Paul",        apellido:"Garcia",       aciertos:5, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    ...
    { nombre:"Francisco",   apellido:"Camacho",      aciertos:4, total:72, campeon: " Portugal | Francia | Argentina | Francia | Octavos " },
    ...
    { nombre:"Jonathan",    apellido:"Di Luca",      aciertos:3, total:72, campeon: " Países Bajos | Portugal | España | Francia | Octavos " },
    ...
    { nombre:"Cristopher",  apellido:"Crespo",       aciertos:2, total:72, campeon: " Argentina | Brasil | Paraguay | Portugal | Octavos " },
    { nombre:"Bolívar",     apellido:"Pérez",        aciertos:0, total:72, campeon: " España | Brasil | Inglaterra | Sudáfrica | Octavos " },
    { nombre:"Steven",      apellido:"Ley",          aciertos:2, total:72, campeon: " Francia | Portugal | Brasil | Francia | Octavos " },
    { nombre:"Freddy",      apellido:"Pincay",       aciertos:3, total:72, campeon: " España | Argentina | Países Bajos | España | Octavos " },
    ...
    { nombre:"Rufo",        apellido:"Castro",       aciertos:2, total:72, campeon: " Portugal | Ecuador | Francia | España | Final " },
    ...
    { nombre:"Livia",       apellido:"Arévalo",      aciertos:1, total:70, campeon: " España | Alemania | Brasil | Argentina | Octavos " },
    { nombre:"Pablo",       apellido:"Zambrano",     aciertos:1, total:70, campeon: " España | Francia | Portugal | España | Octavos " },
