...
const MUNDIAL_DATA = {
  ...
  // ── RANKING
  ranking: [
    { nombre:"Bruno",       apellido:"Arevalo",      aciertos:4, total:72, campeon: " Portugal | España | Brasil | Francia | Cuartos " },
    ...
    { nombre:"Elizabeth",   apellido:"Cabeza",       aciertos:4, total:72, campeon: " Francia | España | Portugal | Francia | Fase de grupos " },
    { nombre:"Victor",      apellido:"Gonzalez",     aciertos:4, total:72, campeon: " España | Portugal | Francia | España | Octavos " },
    { nombre:"Fabian",      apellido:"Cevallos",     aciertos:6, total:72, campeon: " España | Argentina | Francia | España | Octavos " },
    ...
    { nombre:"Gary",        apellido:"Laborde",      aciertos:6, total:72, campeon: " Francia | Portugal | Ecuador | Francia | Semifinales " },
    { nombre:"Julio",       apellido:"Mazacon",      aciertos:6, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    ...
    { nombre:"JEAN",        apellido:"Arévalo",      aciertos:5, total:72, campeon: " Portugal | Francia | Ecuador | Marruecos | Cuartos " },
    { nombre:"Andrea",      apellido:"Soto",         aciertos:7, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    { nombre:"Jose",        apellido:"Garcia",       aciertos:5, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Jose",        apellido:"Bailon",       aciertos:5, total:72, campeon: " Francia | España | Países Bajos | Francia | Cuartos " },
    ...
    { nombre:"Bolívar",     apellido:"Pérez",        aciertos:3, total:72, campeon: " España | Brasil | Inglaterra | Sudáfrica | Octavos " },
    { nombre:"Steven",      apellido:"Ley",          aciertos:4, total:72, campeon: " Francia | Portugal | Brasil | Francia | Octavos " },
    ...
    { nombre:"JUAN",        apellido:"PARRAGA",      aciertos:5, total:70, campeon: " Portugal | España | Ecuador | Portugal | Semifinales " },
    { nombre:"Fernando",    apellido:"Parraga",      aciertos:3, total:70, campeon: " Francia | Portugal | España | Francia | Octavos " },
    { nombre:"Gabriel",     apellido:"Parraga",      aciertos:3, total:70, campeon: " Países Bajos | Portugal | España | Países Bajos | Octavos " },
    { nombre:"Bryan",       apellido:"Parrales",     aciertos:2, total:70, campeon: " Francia | Alemania | Ecuador | España | Cuartos " },
