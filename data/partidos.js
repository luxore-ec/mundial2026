...
const MUNDIAL_DATA = {
  ...
  ranking: [
    { nombre:"Bruno",       apellido:"Arevalo",      aciertos:1, total:72, campeon: " Portugal | España | Brasil | Francia | Cuartos " },
    { nombre:"Toga",        apellido:"Kevin",        aciertos:2, total:72, campeon: " Francia | España | Argentina | Francia | Cuartos " },
    { nombre:"JOSE",        apellido:"XAVIER",       aciertos:2, total:72, campeon: " España | Francia | Argentina | Francia | Octavos " },

    { nombre:"David",       apellido:"Sellan",       aciertos:3, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    { nombre:"Elizabeth",   apellido:"Cabeza",       aciertos:0, total:72, campeon: " Francia | España | Portugal | Francia | Fase de grupos " },

    { nombre:"Victor",      apellido:"Gonzalez",     aciertos:1, total:72, campeon: " España | Portugal | Francia | España | Octavos " },
    { nombre:"Fabian",      apellido:"Cevallos",     aciertos:2, total:72, campeon: " España | Argentina | Francia | España | Octavos " },
    { nombre:"JEFFERSON",   apellido:"ARÉVALO",      aciertos:1, total:72, campeon: " Portugal| Brasil| Ecuador| Francia| Semifinales " },
    { nombre:"Carlos",      apellido:"Delgado",      aciertos:3, total:72, campeon: " Ecuador| Países Bajos| España| Francia| Final " },
    { nombre:"Paul",        apellido:"Garcia",       aciertos:4, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Paul",        apellido:"Rodríguez",    aciertos:3, total:72, campeon: " Portugal | España | Argentina | Brasil | Octavos " },
    { nombre:"Juan",        apellido:"Navarrete",    aciertos:2, total:72, campeon: " Francia| Portugal| Ecuador| Francia| Semifinales " },
    { nombre:"Dussan",      apellido:"Maruri",       aciertos:1, total:72, campeon: " Argentina | Francia | Brasil | Francia | Octavos " },
    { nombre:"Francisco",   apellido:"Camacho",      aciertos:3, total:72, campeon: " Portugal | Francia | Argentina | Francia | Octavos " },
    { nombre:"Gary",        apellido:"Laborde",      aciertos:3, total:72, campeon: " Francia | Portugal | Ecuador | Francia | Semifinales " },
    { nombre:"Julio",       apellido:"Mazacon",      aciertos:2, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    { nombre:"Kelvin",      apellido:"Cornejo",      aciertos:2, total:72, campeon: " España | Francia | Francia | España | Octavos " },
    { nombre:"Julio",       apellido:"Sanchez",      aciertos:3, total:72, campeon: " Portugal | Alemania | Brasil | Portugal | Octavos " },
    { nombre:"Oscar",       apellido:"Ortega",       aciertos:2, total:72, campeon: " Argentina | Francia | España | Francia | Octavos " },
    { nombre:"Andrés",      apellido:"Soto",         aciertos:2, total:72, campeon: " España | Argentina | Portugal | Francia | Octavos " },
    { nombre:"Jonathan",    apellido:"Di Luca",      aciertos:2, total:72, campeon: " Países Bajos | Portugal | España | Francia | Octavos " },
    { nombre:"JEAN",        apellido:"Arévalo",      aciertos:2, total:72, campeon: " Portugal | Francia | Ecuador | Marruecos | Cuartos " },
    { nombre:"Andrea",      apellido:"Soto",         aciertos:4, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    { nombre:"Jose",        apellido:"Garcia",       aciertos:2, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Jose",        apellido:"Bailon",       aciertos:2, total:72, campeon: " Francia | España | Países Bajos | Francia | Cuartos " },
    { nombre:"Joselyn",     apellido:"Salcedo",      aciertos:1, total:72, campeon: " Argentina | Portugal | Ecuador | Ecuador | Semifinales " },
    { nombre:"Jose",        apellido:"Crespo",       aciertos:1, total:72, campeon: " Francia | Argentina | España | Francia | Octavos " },
    { nombre:"Victor",      apellido:"Camacho",      aciertos:1, total:72, campeon: " Portugal | Francia | Brasil | Francia | Cuartos " },
    { nombre:"Marcos",      apellido:"Ramírez",      aciertos:3, total:72, campeon: " Portugal | Francia | Ecuador | Portugal | Semifinales " },
    { nombre:"Mayra",       apellido:"Huerts",       aciertos:3, total:72, campeon: " Portugal | Francia | España | Portugal | Dieciseisavos " },
    { nombre:"Ronny",       apellido:"Moreira",      aciertos:2, total:72, campeon: " Francia | Argentina | Ecuador | Francia | Cuartos " },
    { nombre:"Aldo",        apellido:"Arevalo",      aciertos:2, total:72, campeon: " Portugal | Inglaterra | Argentina | Argentina | Semifinales " },
    { nombre:"Sandy",       apellido:"Carpio",       aciertos:3, total:72, campeon: " Francia | Argentina | Inglaterra | Francia | Fase de grupos " },
    ...
    { nombre:"Steven",      apellido:"Ley",          aciertos:1, total:72, campeon: " Francia | Portugal | Brasil | Francia | Octavos " },
    { nombre:"Freddy",      apellido:"Pincay",       aciertos:2, total:72, campeon: " España | Argentina | Países Bajos | España | Octavos " },
    { nombre:"CARLOS",      apellido:"LOPEZ",        aciertos:4, total:72, campeon: " Francia | Portugal | Ecuador | España | Semifinales " },
    { nombre:"Lissette",    apellido:"Banchon",      aciertos:2, total:72, campeon: " España | Francia | Argentina | Argentina | Octavos " },
    { nombre:"Carlos",      apellido:"Ochoa",        aciertos:2, total:72, campeon: " Francia | Brasil | Ecuador | Francia | Semifinales " },
    ...
    { nombre:"JUAN",        apellido:"PARRAGA",      aciertos:1, total:70, campeon: " Portugal | España | Ecuador | Portugal | Semifinales " },
    ...
    { nombre:"Josue",       apellido:"Villacis",     aciertos:1, total:70, campeon: " Brasil | Francia | Ecuador | Brasil | Cuartos " },
    { nombre:"Junior",      apellido:"Castro",       aciertos:1, total:70, campeon: " Francia | Alemania | Argentina | Francia | Octavos " }
