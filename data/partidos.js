...
const MUNDIAL_DATA = {
  ...
  ranking: [
    ...
    { nombre:"JOSE",        apellido:"XAVIER",       aciertos:1, total:72, campeon: " España | Francia | Argentina | Francia | Octavos " },
    ...
    { nombre:"Paul",        apellido:"Garcia",       aciertos:3, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Paul",        apellido:"Rodríguez",    aciertos:2, total:72, campeon: " Portugal | España | Argentina | Brasil | Octavos " },
    { nombre:"Juan",        apellido:"Navarrete",    aciertos:1, total:72, campeon: " Francia| Portugal| Ecuador| Francia| Semifinales " },
    ...
    { nombre:"Gary",        apellido:"Laborde",      aciertos:2, total:72, campeon: " Francia | Portugal | Ecuador | Francia | Semifinales " },
    ...
    { nombre:"Andrea",      apellido:"Soto",         aciertos:3, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    ...
    { nombre:"Marcos",      apellido:"Ramírez",      aciertos:2, total:72, campeon: " Portugal | Francia | Ecuador | Portugal | Semifinales " },
