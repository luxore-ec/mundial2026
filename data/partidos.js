const MUNDIAL_DATA = {
  ...
  // ── RANKING
  ranking: [
    { nombre:"Bruno",       apellido:"Arevalo",      aciertos:11, total:72, campeon: " Portugal | España | Brasil | Francia | Cuartos " },
    { nombre:"Toga",        apellido:"Kevin",        aciertos:11, total:72, campeon: " Francia | España | Argentina | Francia | Cuartos " },
    { nombre:"JOSE",        apellido:"XAVIER",       aciertos:11, total:72, campeon: " España | Francia | Argentina | Francia | Octavos " },
    { nombre:"David",       apellido:"Sellan",       aciertos:12, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    { nombre:"Elizabeth",   apellido:"Cabeza",       aciertos:10, total:72, campeon: " Francia | España | Portugal | Francia | Fase de grupos " },
    { nombre:"Victor",      apellido:"Gonzalez",     aciertos:10, total:72, campeon: " España | Portugal | Francia | España | Octavos " },
    { nombre:"Fabian",      apellido:"Cevallos",     aciertos:13, total:72, campeon: " España | Argentina | Francia | España | Octavos " },
    { nombre:"JEFFERSON",   apellido:"ARÉVALO",      aciertos:8, total:72, campeon: " Portugal| Brasil| Ecuador| Francia| Semifinales " },
    { nombre:"Carlos",      apellido:"Delgado",      aciertos:9, total:72, campeon: " Ecuador| Países Bajos| España| Francia| Final " },
    { nombre:"Paul",        apellido:"Garcia",       aciertos:14, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },

    { nombre:"Paul",        apellido:"Rodríguez",    aciertos:11, total:72, campeon: " Portugal | España | Argentina | Brasil | Octavos " },
    ...
    { nombre:"Kelvin",      apellido:"Cornejo",      aciertos:10, total:72, campeon: " España | Francia | Francia | España | Octavos " },
    { nombre:"Julio",       apellido:"Sanchez",      aciertos:12, total:72, campeon: " Portugal | Alemania | Brasil | Portugal | Octavos " },
    { nombre:"Oscar",       apellido:"Ortega",       aciertos:11, total:72, campeon: " Argentina | Francia | España | Francia | Octavos " },
    { nombre:"Andrés",      apellido:"Soto",         aciertos:11, total:72, campeon: " España | Argentina | Portugal | Francia | Octavos " },

    { nombre:"Jonathan",    apellido:"Di Luca",      aciertos:11, total:72, campeon: " Países Bajos | Portugal | España | Francia | Octavos " },
    { nombre:"JEAN",        apellido:"Arévalo",      aciertos:10, total:72, campeon: " Portugal | Francia | Ecuador | Marruecos | Cuartos " },
    { nombre:"Andrea",      apellido:"Soto",         aciertos:14, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    { nombre:"Jose",        apellido:"Garcia",       aciertos:12, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Jose",        apellido:"Bailon",       aciertos:11, total:72, campeon: " Francia | España | Países Bajos | Francia | Cuartos " },
    { nombre:"Joselyn",     apellido:"Salcedo",      aciertos:9, total:72, campeon: " Argentina | Portugal | Ecuador | Ecuador | Semifinales " },
    { nombre:"Jose",        apellido:"Crespo",       aciertos:9, total:72, campeon: " Francia | Argentina | España | Francia | Octavos " },
    { nombre:"Victor",      apellido:"Camacho",      aciertos:11, total:72, campeon: " Portugal | Francia | Brasil | Francia | Cuartos " },
    { nombre:"Marcos",      apellido:"Ramírez",      aciertos:11, total:72, campeon: " Portugal | Francia | Ecuador | Portugal | Semifinales " },
    ...
    { nombre:"Aldo",        apellido:"Arevalo",      aciertos:7, total:72, campeon: " Portugal | Inglaterra | Argentina | Argentina | Semifinales " },
    ...
    { nombre:"Steven",      apellido:"Ley",          aciertos:11, total:72, campeon: " Francia | Portugal | Brasil | Francia | Octavos " },
    { nombre:"Freddy",      apellido:"Pincay",       aciertos:10, total:72, campeon: " España | Argentina | Países Bajos | España | Octavos " },
    { nombre:"CARLOS",      apellido:"LOPEZ",        aciertos:15, total:72, campeon: " Francia | Portugal | Ecuador | España | Semifinales " },
    { nombre:"Lissette",    apellido:"Banchon",      aciertos:9, total:72, campeon: " España | Francia | Argentina | Argentina | Octavos " },
    { nombre:"Carlos",      apellido:"Ochoa",        aciertos:13, total:72, campeon: " Francia | Brasil | Ecuador | Francia | Semifinales " },

    { nombre:"Rufo",        apellido:"Castro",       aciertos:10, total:72, campeon: " Portugal | Ecuador | Francia | España | Final " },
    { nombre:"Jorge",       apellido:"Rodriguez",    aciertos:10, total:72, campeon: " España | Portugal | Francia | España | Octavos " },    
    { nombre:"JUAN",        apellido:"PARRAGA",      aciertos:12, total:70, campeon: " Portugal | España | Ecuador | Portugal | Semifinales " },
    { nombre:"Fernando",    apellido:"Parraga",      aciertos:9, total:70, campeon: " Francia | Portugal | España | Francia | Octavos " },
    { nombre:"Gabriel",     apellido:"Parraga",      aciertos:10, total:70, campeon: " Países Bajos | Portugal | España | Países Bajos | Octavos " },
    { nombre:"Bryan",       apellido:"Parrales",     aciertos:8, total:70, campeon: " Francia | Alemania | Ecuador | España | Cuartos " },
    { nombre:"Livia",       apellido:"Arévalo",      aciertos:7, total:70, campeon: " España | Alemania | Brasil | Argentina | Octavos " },
    { nombre:"Pablo",       apellido:"Zambrano",     aciertos:10, total:70, campeon: " España | Francia | Portugal | España | Octavos " },
    { nombre:"Josue",       apellido:"Villacis",     aciertos:8, total:70, campeon: " Brasil | Francia | Ecuador | Brasil | Cuartos " },
    { nombre:"Junior",      apellido:"Castro",       aciertos:8, total:70, campeon: " Francia | Alemania | Argentina | Francia | Octavos " }
