...
const MUNDIAL_DATA = {
  ...
  ranking: [
    ...
    { nombre:"Toga", apellido:"Kevin",      aciertos:1, total:72, campeon: " Francia | España | Argentina | Francia | Cuartos " },
    { nombre:"JOSE",     apellido:"XAVIER",   aciertos:1, total:72, campeon: " España | Francia | Argentina | Francia | Octavos " },

    { nombre:"David",     apellido:"Sellan",   aciertos:1, total:72, campeon: " Francia | España | Argentina | Francia | Octavos " },
    ...
    { nombre:"Fabian",    apellido:"Cevallos",      aciertos:1, total:72, campeon: " España | Argentina | Francia | España | Octavos " },
    { nombre:"JEFFERSON",    apellido:"ARÉVALO",      aciertos:0, total:72, campeon: " Portugal| Brasil| Ecuador| Francia| Semifinales " },
    { nombre:"Carlos",    apellido:"Delgado",      aciertos:1, total:72, campeon: " Ecuador| Países Bajos| España| Francia| Final " },
    { nombre:"Paul",    apellido:"Garcia",      aciertos:1, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Paul",    apellido:"Rodríguez",      aciertos:1, total:72, campeon: " Portugal | España | Argentina | Brasil | Octavos " },
    { nombre:"Juan",    apellido:"Navarrete",      aciertos:0, total:72, campeon: " Francia| Portugal| Ecuador| Francia| Semifinales " },
    { nombre:"Dussan",    apellido:"Maruri",      aciertos:1, total:72, campeon: " Argentina | Francia | Brasil | Francia | Octavos " },
    { nombre:"Francisco",    apellido:"Camacho",      aciertos:1, total:72, campeon: " Portugal | Francia | Argentina | Francia | Octavos " },
    { nombre:"Gary",    apellido:"Laborde",      aciertos:1, total:72, campeon: " Francia | Portugal | Ecuador | Francia | Semifinales " },
    ...
    { nombre:"Julio",    apellido:"Sanchez",      aciertos:1, total:72, campeon: " Portugal | Alemania | Brasil | Portugal | Octavos " },
    { nombre:"Oscar",    apellido:"Ortega",      aciertos:1, total:72, campeon: " Argentina | Francia | España | Francia | Octavos " },
    { nombre:"Andrés",    apellido:"Soto",      aciertos:1, total:72, campeon: " España | Argentina | Portugal | Francia | Octavos " },
    { nombre:"Jonathan",    apellido:"Di Luca",      aciertos:1, total:72, campeon: " Países Bajos | Portugal | España | Francia | Octavos " },
    { nombre:"JEAN",    apellido:"Arévalo",      aciertos:1, total:72, campeon: "Portugal | Francia | Ecuador | Marruecos | Cuartos " },
    { nombre:"Andrea",    apellido:"Soto",      aciertos:1, total:72, campeon: " España | Francia | Argentina | España | Octavos " },
    { nombre:"Jose",    apellido:"Garcia",      aciertos:1, total:72, campeon: " Portugal | España | Argentina | Portugal | Cuartos " },
    { nombre:"Jose",    apellido:"Bailon",      aciertos:1, total:72, campeon: " Francia | España | Países Bajos | Francia | Cuartos " },
    { nombre:"Joselyn",    apellido:"Salcedo",      aciertos:0, total:72, campeon: " Argentina | Portugal | Ecuador | Ecuador | Semifinales " },
    ...
    { nombre:"Aldo",    apellido:"Arevalo",      aciertos:0, total:72, campeon: " Portugal | Inglaterra | Argentina | Argentina | Semifinales " },
    { nombre:"Sandy",    apellido:"Carpio",      aciertos:1, total:72, campeon: " Francia | Argentina | Inglaterra | Francia | Fase de grupos " },
    { nombre:"Cristopher",    apellido:"Crespo",      aciertos:0, total:72, campeon: " Argentina | Brasil | Paraguay | Portugal | Octavos " },
    ...
    { nombre:"Freddy",    apellido:"Pincay",      aciertos:0, total:72, campeon: " España | Argentina | Países Bajos | España | Octavos " },
    { nombre:"CARLOS",    apellido:"LOPEZ",      aciertos:1, total:72, campeon: " Francia | Portugal | Ecuador | España | Semifinales " },
